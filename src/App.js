import { IonApp, IonPage, IonRouterOutlet, IonSpinner, IonSplitPane, useIonRouter } from '@ionic/react';
...
const App = () => {
  ...
  if (initialRoute === undefined) {
    return (
      <div style={{background: COLORS.bg, height: "100vh", width: "100vw", position: "fixed", top: 0, left: 0, display: "flex", justifyContent: 'center', alignItems: 'center', }}>
          <IonSpinner />
      </div>
    );
          ...
          <IonReactRouter>
            <IonSplitPane contentId="main">
              <IonRouterOutlet id="main">
                ...
                <Route
                  path="/tabs"
                  render={() => (initialRoute == 'Onboarding' ? <Onboarding /> : <Tabs />)}
                />
