[
  {
    Ac: {
      ...
      'Shannon radii': { 3: { VI: { '': { crystal_radius: 1.26, ionic_radius: 1.12 } } } },
    ...
    Ag: {
      ...
      'ICSD oxidation states': [1, 2, 3],
      'Ionic radii': { 1: 1.29, 2: 1.08, 3: 0.89 },
    ...
    Al: {
      ...
      'NMR Quadrupole Moment': { 'Al-27': 146.6 },
    ...
    Am: {
      ...
      'Ionic radii': { 2: 1.4, 3: 1.115, 4: 0.99 },
      'Liquid range': '1431 K',
    ...
    As: {
      ...
      'ICSD oxidation states': [2, 3, 5, -2, -3, -1],
      'Ionic radii': { 3: 0.72, 5: 0.6 },
      'Liquid range': '203 K',
    ...
    At: {
      ...
      'Refractive index': 'no data',
      'Rigidity modulus': 'no data GPa',
      'Shannon radii': { 7: { VI: { '': { crystal_radius: 0.76, ionic_radius: 0.62 } } } },
      'Superconduction temperature': 'no data K',
    ...
    Au: {
      ...
      'Ionic radii': { 1: 1.51, 3: 0.99, 5: 0.71 },
    ...
    B: {
      'Atomic mass': 10.811,
      'Atomic no': 5,
      'Atomic orbitals': { '1s': -6.564347, '2p': -0.136603, '2s': -0.344701 },
      'Atomic radius': 0.85,
      ...
      X: 2.04,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'B-10': 84.59, 'B-11': 40.59 },
      'Metallic radius': 'no data',
      iupac_ordering: 81,
      'IUPAC ordering': 81,
      'Ground level': '2P\u00b01/2',
      'Ionization energies': [8.298019, 25.15483, 37.93059, 259.3715, 340.2260229],
    ...
    Ba: {
      ...
      'Shannon radii': {
        2: {
          ...
          X: { '': { crystal_radius: 1.66, ionic_radius: 1.52 } },
    ...
    Be: {
      ...
      'Atomic no': 4,
      'Atomic orbitals': { '1s': -3.856411, '2s': -0.205744 },
      'Atomic radius': 1.05,
      ...
      'NMR Quadrupole Moment': { 'Be-9': 52.88 },
      'Metallic radius': 1.12,
      iupac_ordering: 17,
      'IUPAC ordering': 17,
      'Ground level': '1S0',
      'Ionization energies': [9.322699, 18.21115, 153.896205, 217.7185861],
    ...
    Bi: {
      ...
      'ICSD oxidation states': [1, 2, 3, 5],
      'Ionic radii': { 3: 1.17, 5: 0.9 },
    ...
    Br: {
      ...
      'ICSD oxidation states': [5, -1],
      'Ionic radii': { '-1': 1.82, 3: 0.73, 5: 0.45, 7: 0.53 },
      'Liquid range': '66.2 K',
    ...
    C: {
      'Atomic mass': 12.0107,
      'Atomic no': 6,
      'Atomic orbitals': { '1s': -9.947718, '2p': -0.199186, '2s': -0.500866 },
      'Atomic radius': 0.7,
      ...
      'ICSD oxidation states': [2, 3, 4, -4, -3, -2],
      'Ionic radii': { 4: 0.3 },
      'Liquid range': '500 K',
      ...
      X: 2.55,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'C-11': 33.27 },
      'Metallic radius': 'no data',
      iupac_ordering: 86,
      'IUPAC ordering': 86,
      'Ground level': '3P0',
      'Ionization energies': [11.260288, 24.383154, 47.88778, 64.49352, 392.090518, 489.993198],
    ...
    Ca: {
      ...
      'Shannon radii': {
        2: {
          ...
          X: { '': { crystal_radius: 1.37, ionic_radius: 1.23 } },
      ...
      'NMR Quadrupole Moment': { 'Ca-41': -66.5, 'Ca-43': -40.8 },
    ...
    Cl: {
      ...
      'ICSD oxidation states': [-1],
      'Ionic radii': { '-1': 1.67, 5: 0.26, 7: 0.41 },
      ...
      X: 3.16,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'Cl-35': -81.65, 'Cl-37': -64.35 },
      'Metallic radius': 'no data',
      iupac_ordering: 101,
      'IUPAC ordering': 101,
      'Ground level': '2P\u00b03/2',
    ...
    Cr: {
      ...
      'Ionic radii': { 2: 0.94 },
      'Ionic radii hs': { 2: 0.94 },
      'Ionic radii ls': { 2: 0.87, 3: 0.755, 4: 0.69, 5: 0.63, 6: 0.58 },
      'Liquid range': '764 K',
      ...
      'NMR Quadrupole Moment': { 'Cr-53': -150.5 },
    ...
    Cs: {
      ...
      'Shannon radii': {
        1: {
          ...
          X: { '': { crystal_radius: 1.95, ionic_radius: 1.81 } },
    ...
    Cu: {
      ...
      'NMR Quadrupole Moment': { 'Cu-63': -220.15, 'Cu-65': -204.14 },
    ...
    Eu: {
      ...
      'Shannon radii': {
        2: {
          ...
          X: { '': { crystal_radius: 1.49, ionic_radius: 1.35 } },
        },
        3: {
    ...
    F: {
      ...
      'Atomic no': 9,
      'Atomic orbitals': { '1s': -24.189391, '2p': -0.415606, '2s': -1.086859 },
      'Atomic radius': 0.5,
      ...
      X: 3.98,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'F-19': -94.2 },
      'Metallic radius': 'no data',
      iupac_ordering: 102,
      'IUPAC ordering': 102,
      'Ground level': '2P\u00b03/2',
    ...
    Fr: {
      ...
      'Refractive index': 'no data',
      'Rigidity modulus': 'no data GPa',
      'Shannon radii': { 1: { VI: { '': { crystal_radius: 1.94, ionic_radius: 1.8 } } } },
      'Superconduction temperature': 'no data K',
      'Thermal conductivity': 'no data W m<sup>-1</sup> K<sup>-1</sup>',
    ...
    H: {
      ...
      X: 2.2,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'H-2': 2.86 },
      'Metallic radius': 'no data',
      iupac_ordering: 92,
      'IUPAC ordering': 92,
      'Ground level': '2S1/2',
      'Ionization energies': [13.598434599702],
      'Electron affinity': 0.754598,
    },
    He: {
      'Atomic mass': 4.002602,
      'Atomic no': 2,
      'Atomic orbitals': { '1s': -0.570425 },
      'Atomic radius': 'no data',
      ...
      'IUPAC ordering': 5,
      'Ground level': '1S0',
      'Ionization energies': [24.587389011, 54.417765486],
      'Electron affinity': -0.52,
    },
    Hf: {
      'Atomic mass': 178.49,
    ...
    Hg: {
      ...
      'ICSD oxidation states': [1, 2],
      'Ionic radii': { 1: 1.33, 2: 1.16 },
      ...
      X: 2.0,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'Hg-201': 387.6 },
      'Metallic radius': 1.51,
      iupac_ordering: 74,
      'IUPAC ordering': 74,
      'Ground level': '1S0',
    ...
    Ho: {
      ...
      'Shannon radii': {
        3: {
          ...
          X: { '': { crystal_radius: 1.26, ionic_radius: 1.12 } },
        },
      },
      'Superconduction temperature': 'no data K',
    ...
    I: {
      ...
      'ICSD oxidation states': [5, -1],
      'Ionic radii': { '-1': 2.06, 5: 1.09, 7: 0.67 },
      ...
      X: 2.66,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'I-127': -696.12, 'I-129': -604.1 },
      'Metallic radius': 'no data',
      iupac_ordering: 99,
      'IUPAC ordering': 99,
      'Ground level': '2P\u00b03/2',
    ...
    In: {
      ...
      'NMR Quadrupole Moment': { 'In-113': 759.8, 'In-115': 770.8 },
    ...
    Ir: {
      ...
      'ICSD oxidation states': [3, 4, 5],
      'Ionic radii': { 3: 0.82, 4: 0.765, 5: 0.71 },
      'Liquid range': '1962 K',
    ...
    K: {
      ...
      'Shannon radii': {
        1: {
          ...
          X: { '': { crystal_radius: 1.73, ionic_radius: 1.59 } },
      ...
      X: 0.82,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'K-39': 58.5, 'K-40': -73.0, 'K-41': 71.1 },
    ...
    La: {
      ...
      'Shannon radii': {
        3: {
          ...
          X: { '': { crystal_radius: 1.41, ionic_radius: 1.27 } },
      ...
      'NMR Quadrupole Moment': { 'La-139': 200.6 },
    ...
    Li: {
      'Atomic mass': 6.941,
      'Atomic no': 3,
      'Atomic orbitals': { '1s': -1.878564, '2s': -0.10554 },
      'Atomic radius': 1.45,
      ...
      'NMR Quadrupole Moment': { 'Li-6': -0.808, 'Li-7': -40.1 },
      'Metallic radius': 1.52,
      iupac_ordering: 11,
      'IUPAC ordering': 11,
      'Ground level': '2S1/2',
      'Ionization energies': [5.391714996, 75.640097, 122.45435914],
    ...
    Mg: {
      'Atomic mass': 24.305,
      'Atomic no': 12,
      'Atomic orbitals': { '1s': -45.973167, '2p': -1.71897, '2s': -2.903746, '3s': -0.175427 },
      'Atomic radius': 1.5,
      'Atomic radius calculated': 1.45,
      ...
      'NMR Quadrupole Moment': { 'Mg-25': 199.4 },
      'Metallic radius': 1.6,
      iupac_ordering: 16,
      'IUPAC ordering': 16,
      'Ground level': '1S0',
    ...
    Mn: {
      ...
      'ICSD oxidation states': [2, 3, 4, 7],
      'Ionic radii': { 2: 0.97, 3: 0.785, 4: 0.67, 5: 0.47, 6: 0.395, 7: 0.6 },
      'Ionic radii hs': { 2: 0.97, 3: 0.785 },
      'Ionic radii ls': { 2: 0.81, 3: 0.72, 4: 0.67, 5: 0.47, 6: 0.395, 7: 0.6 },
      'Liquid range': '815 K',
      ...
      'NMR Quadrupole Moment': { 'Mn-55': 330.1 },
    ...
    Mo: {
      ...
      'ICSD oxidation states': [2, 3, 4, 5, 6],
      'Ionic radii': { 3: 0.83, 4: 0.79, 5: 0.75, 6: 0.73 },
      'Liquid range': '2016 K',
    ...
    N: {
      'Atomic mass': 14.0067,
      'Atomic no': 7,
      'Atomic orbitals': { '1s': -14.011501, '2p': -0.266297, '2s': -0.676151 },
      'Atomic radius': 0.65,
      ...
      'ICSD oxidation states': [1, 3, 5, -1, -3, -2],
      'Ionic radii': { '-3': 1.32, 3: 0.3, 5: 0.27 },
      ...
      X: 3.04,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'N-14': 20.44 },
      'Metallic radius': 'no data',
      iupac_ordering: 91,
      'IUPAC ordering': 91,
      'Ground level': '4S\u00b03/2',
      'Ionization energies': [14.53413, 29.60125, 47.4453, 77.4735, 97.8901, 552.06733, 667.046121],
      'Electron affinity': -0.07,
    },
    Na: {
      'Atomic mass': 22.98976928,
      'Atomic no': 11,
      'Atomic orbitals': { '1s': -37.719975, '2p': -1.060636, '2s': -2.063401, '3s': -0.103415 },
      'Atomic radius': 1.8,
      'Atomic radius calculated': 1.9,
      ...
      'NMR Quadrupole Moment': { 'Na-23': 104.1 },
      'Metallic radius': 1.86,
      iupac_ordering: 10,
      'IUPAC ordering': 10,
      'Ground level': '2S1/2',
    ...
    Nb: {
      ...
      'ICSD oxidation states': [2, 3, 4, 5],
      'Ionic radii': { 3: 0.86, 4: 0.82, 5: 0.78 },
      'Liquid range': '2267 K',
    ...
    Ne: {
      'Atomic mass': 20.1797,
      'Atomic no': 10,
      'Atomic orbitals': { '1s': -30.305855, '2p': -0.498034, '2s': -1.322809 },
      'Atomic radius': 'no data',
      ...
      'Vickers hardness': 'no data MN m<sup>-2</sup>',
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'Ne-21': 101.55 },
      'Metallic radius': 'no data',
      iupac_ordering: 4,
      'IUPAC ordering': 4,
      'Ground level': '1S0',
    ...
    Ni: {
      ...
      'NMR Quadrupole Moment': { 'Ni-61': 162.15 },
    ...
    No: {
      ...
      'Refractive index': 'no data',
      'Rigidity modulus': 'no data GPa',
      'Shannon radii': { 2: { VI: { '': { crystal_radius: 1.24, ionic_radius: 1.1 } } } },
      'Superconduction temperature': 'no data K',
      'Thermal conductivity': 'no data W m<sup>-1</sup> K<sup>-1</sup>',
      'Van der waals radius': 2.46,
      'Velocity of sound': 'no data m s<sup>-1</sup>',
    ...
    Np: {
      ...
      'Ionic radii': { 2: 1.24, 3: 1.15, 4: 1.01, 5: 0.89, 6: 0.86, 7: 0.85 },
      'Liquid range': '3363 K',
      'Melting point': '910 K',
      'Mendeleev no': 44,
      'Mineral hardness': 'no data',
    ...
    Os: {
      ...
      'Ionic radii': { 4: 0.77, 5: 0.715, 6: 0.685, 7: 0.665, 8: 0.53 },
      'Liquid range': '1979 K',
    ...
    P: {
      ...
      'ICSD oxidation states': [3, 4, 5, -2, -3, -1],
      'Ionic radii': { 3: 0.58, 5: 0.52 },
    ...
    Pa: {
      ...
      'Ionic radii': { 3: 1.16, 4: 1.04, 5: 0.92 },
      'Liquid range': 'no data K',
    ...
    Pb: {
      ...
      'ICSD oxidation states': [2, 4],
      'Ionic radii': { 2: 1.33, 4: 0.915 },
      ...
      'Shannon radii': {
        2: {
          ...
          VIII: { '': { crystal_radius: 1.43, ionic_radius: 1.29 } },
          IX: { '': { crystal_radius: 1.49, ionic_radius: 1.35 } },
          X: { '': { crystal_radius: 1.54, ionic_radius: 1.4 } },
    ...
    Pd: {
      ...
      'ICSD oxidation states': [2, 4],
      'Ionic radii': { 1: 0.73, 2: 1.0, 3: 0.9, 4: 0.755 },
    ...
    Pt: {
      ...
      'Ionic radii': { 2: 0.94, 4: 0.765, 5: 0.71 },
    ...
    Pu: {
      ...
      'Ionic radii': { 3: 1.14, 4: 1.0, 5: 0.88, 6: 0.85 },
    ...
    Ra: {
      ...
      X: 0.9,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'Ra-223': 1210.3 },
    ...
    Rb: {
      ...
      'Shannon radii': {
        1: {
          ...
          X: { '': { crystal_radius: 1.8, ionic_radius: 1.66 } },
    ...
    Re: {
      ...
      'ICSD oxidation states': [3, 4, 5, 6, 7],
      'Ionic radii': { 4: 0.77, 5: 0.72, 6: 0.69, 7: 0.67 },
      'Liquid range': '2410 K',
    ...
    Rh: {
      ...
      'ICSD oxidation states': [3, 4],
      'Ionic radii': { 3: 0.805, 4: 0.74, 5: 0.69 },
      'Liquid range': '1731 K',
    ...
    S: {
      ...
      'ICSD oxidation states': [-1, 2, 4, -2, 6],
      'Ionic radii': { '-2': 1.7, 4: 0.51, 6: 0.43 },
      ...
      X: 2.58,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'S-33': -67.8, 'S-35': 47.1 },
      'Metallic radius': 'no data',
      iupac_ordering: 96,
      'IUPAC ordering': 96,
      'Ground level': '3P2',
    ...
    Sb: {
      ...
      'ICSD oxidation states': [-2, 3, 5, -1, -3],
      'Ionic radii': { 3: 0.9, 5: 0.76 },
      ...
      X: 2.05,
      'Youngs modulus': '55 GPa',
      'NMR Quadrupole Moment': { 'Sb-121': -543.11, 'Sb-123': -692.14 },
    ...
    Sc: {
      ...
      'NMR Quadrupole Moment': { 'Sc-45': -220.2 },
    ...
    Sm: {
      ...
      'ICSD oxidation states': [2, 3],
      'Ionic radii': { 2: 1.36, 3: 1.0979999999999999 },
      'Liquid range': '731 K',
    ...
    Sn: {
      ...
      X: 1.96,
      'Youngs modulus': '50 GPa',
      'NMR Quadrupole Moment': { 'Sn-119': -132.1 },
      'Metallic radius': 1.58,
      iupac_ordering: 83,
      'IUPAC ordering': 83,
      'Ground level': '3P0',
    ...
    Sr: {
      ...
      'Shannon radii': {
        2: {
          ...
          VIII: { '': { crystal_radius: 1.4, ionic_radius: 1.26 } },
          IX: { '': { crystal_radius: 1.45, ionic_radius: 1.31 } },
          X: { '': { crystal_radius: 1.5, ionic_radius: 1.36 } },
      ...
      X: 0.95,
      'Youngs modulus': 'no data GPa',
      'NMR Quadrupole Moment': { 'Sr-87': 305.2 },
    ...
    Tc: {
      ...
      'Ionic radii': { 4: 0.785, 5: 0.74, 7: 0.7 },
      'Liquid range': '2108 K',
    ...
    Th: {
      ...
      'Shannon radii': {
        4: {
          ...
          X: { '': { crystal_radius: 1.27, ionic_radius: 1.13 } },
    ...
    Ti: {
      ...
      'ICSD oxidation states': [2, 3, 4],
      'Ionic radii': { 2: 1.0, 3: 0.81, 4: 0.745 },
      'Liquid range': '1619 K',
      ...
      'NMR Quadrupole Moment': { 'Ti-47': 302.1, 'Ti-49': 247.11 },
    ...
    Tl: {
      ...
      'ICSD oxidation states': [1, 3],
      'Ionic radii': { 1: 1.64, 3: 1.025 },
      'Liquid range': '1169 K',
      'Melting point': '577 K',
      'Mendeleev no': 78,
      'Mineral hardness': '1.2',
    ...
    U: {
      ...
      'ICSD oxidation states': [3, 4, 5, 6],
      'Ionic radii': { 3: 1.165, 4: 1.03, 5: 0.9, 6: 0.87 },
    ...
    V: {
      ...
      'ICSD oxidation states': [2, 3, 4, 5],
      'Ionic radii': { 2: 0.93, 3: 0.78, 4: 0.72, 5: 0.68 },
      'Liquid range': '1497 K',
      ...
      'NMR Quadrupole Moment': { 'V-50': 210.4, 'V-51': -52.1 },
    ...
    W: {
      ...
      'ICSD oxidation states': [2, 3, 4, 5, 6],
      'Ionic radii': { 4: 0.8, 5: 0.76, 6: 0.74 },
      'Liquid range': '2133 K',
    ...
    Zn: {
      ...
      'NMR Quadrupole Moment': { 'Zn-67': 150.15 },
